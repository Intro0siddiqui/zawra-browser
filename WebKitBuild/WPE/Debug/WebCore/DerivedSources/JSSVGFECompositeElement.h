...
public:
    ...
    {
        JSSVGFECompositeElement* ptr = new (NotNull, JSC::allocateCell<JSSVGFECompositeElement>(globalObject->vm())) JSSVGFECompositeElement(structure, *globalObject, WTFMove(impl));
