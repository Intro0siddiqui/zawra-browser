...
template<> GPUCommandEncoderDescriptor convertDictionary<GPUCommandEncoderDescriptor>(JSGlobalObject& lexicalGlobalObject, JSValue value)
{
    ...
    GPUCommandEncoderDescriptor result;
    JSValue labelValue;
