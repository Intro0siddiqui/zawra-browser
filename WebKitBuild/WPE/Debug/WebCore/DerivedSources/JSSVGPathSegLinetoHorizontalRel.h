...
public:
    ...
    {
        JSSVGPathSegLinetoHorizontalRel* ptr = new (NotNull, JSC::allocateCell<JSSVGPathSegLinetoHorizontalRel>(globalObject->vm())) JSSVGPathSegLinetoHorizontalRel(structure, *globalObject, WTFMove(impl));
