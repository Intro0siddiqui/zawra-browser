...
public:
    ...
    {
        JSSVGFEDropShadowElement* ptr = new (NotNull, JSC::allocateCell<JSSVGFEDropShadowElement>(globalObject->vm())) JSSVGFEDropShadowElement(structure, *globalObject, WTFMove(impl));
