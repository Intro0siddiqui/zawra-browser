...
public:
    ...
    {
        JSSVGTextPositioningElement* ptr = new (NotNull, JSC::allocateCell<JSSVGTextPositioningElement>(globalObject->vm())) JSSVGTextPositioningElement(structure, *globalObject, WTFMove(impl));
