...
public:
    ...
    {
        JSSVGPathSegList* ptr = new (NotNull, JSC::allocateCell<JSSVGPathSegList>(globalObject->vm())) JSSVGPathSegList(structure, *globalObject, WTFMove(impl));
...
class JSSVGPathSegListOwner final : public JSC::WeakHandleOwner {
public:
