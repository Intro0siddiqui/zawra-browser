...
public:
    ...
    {
        JSSVGPathSegLinetoRel* ptr = new (NotNull, JSC::allocateCell<JSSVGPathSegLinetoRel>(globalObject->vm())) JSSVGPathSegLinetoRel(structure, *globalObject, WTFMove(impl));
