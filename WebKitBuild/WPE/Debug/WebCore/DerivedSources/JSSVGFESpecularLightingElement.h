...
public:
    ...
    {
        JSSVGFESpecularLightingElement* ptr = new (NotNull, JSC::allocateCell<JSSVGFESpecularLightingElement>(globalObject->vm())) JSSVGFESpecularLightingElement(structure, *globalObject, WTFMove(impl));
