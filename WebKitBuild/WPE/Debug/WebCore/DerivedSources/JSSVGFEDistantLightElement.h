...
public:
    ...
    {
        JSSVGFEDistantLightElement* ptr = new (NotNull, JSC::allocateCell<JSSVGFEDistantLightElement>(globalObject->vm())) JSSVGFEDistantLightElement(structure, *globalObject, WTFMove(impl));
