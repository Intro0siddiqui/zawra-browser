...
public:
    ...
    {
        JSSVGAnimateColorElement* ptr = new (NotNull, JSC::allocateCell<JSSVGAnimateColorElement>(globalObject->vm())) JSSVGAnimateColorElement(structure, *globalObject, WTFMove(impl));
