...
public:
    ...
    {
        JSSVGFEColorMatrixElement* ptr = new (NotNull, JSC::allocateCell<JSSVGFEColorMatrixElement>(globalObject->vm())) JSSVGFEColorMatrixElement(structure, *globalObject, WTFMove(impl));
