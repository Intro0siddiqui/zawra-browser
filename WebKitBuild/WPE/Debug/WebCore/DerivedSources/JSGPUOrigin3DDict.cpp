...
template<> GPUOrigin3DDict convertDictionary<GPUOrigin3DDict>(JSGlobalObject& lexicalGlobalObject, JSValue value)
{
    ...
    if (!zValue.isUndefined()) {
        result.z = convert<IDLEnforceRangeAdaptor<IDLUnsignedLong>>(lexicalGlobalObject, zValue);
        RETURN_IF_EXCEPTION(throwScope, { });
    } else
        result.z = 0;
    return result;
