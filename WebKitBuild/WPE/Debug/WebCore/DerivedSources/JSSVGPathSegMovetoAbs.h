...
public:
    ...
    {
        JSSVGPathSegMovetoAbs* ptr = new (NotNull, JSC::allocateCell<JSSVGPathSegMovetoAbs>(globalObject->vm())) JSSVGPathSegMovetoAbs(structure, *globalObject, WTFMove(impl));
