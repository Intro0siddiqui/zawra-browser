...
template<> GPUImageCopyBuffer convertDictionary<GPUImageCopyBuffer>(JSGlobalObject& lexicalGlobalObject, JSValue value)
{
    ...
    if (!bufferValue.isUndefined()) {
        ...
        throwRequiredMemberTypeError(lexicalGlobalObject, throwScope, "buffer", "GPUImageCopyBuffer", "GPUBuffer");
        return { };
    }
    return result;
}
