...
public:
    ...
    {
        JSOESTextureFloatLinear* ptr = new (NotNull, JSC::allocateCell<JSOESTextureFloatLinear>(globalObject->vm())) JSOESTextureFloatLinear(structure, *globalObject, WTFMove(impl));
