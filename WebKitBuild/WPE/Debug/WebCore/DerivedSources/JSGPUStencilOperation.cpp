...
template<> const char* expectedEnumerationValues<GPUStencilOperation>()
{
    return "\"keep\", \"zero\", \"replace\", \"invert\", \"increment-clamp\", \"decrement-clamp\", \"increment-wrap\", \"decrement-wrap\"";
}
