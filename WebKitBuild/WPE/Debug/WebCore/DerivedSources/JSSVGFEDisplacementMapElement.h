...
public:
    ...
    {
        JSSVGFEDisplacementMapElement* ptr = new (NotNull, JSC::allocateCell<JSSVGFEDisplacementMapElement>(globalObject->vm())) JSSVGFEDisplacementMapElement(structure, *globalObject, WTFMove(impl));
