...
static const HashTableValue JSGPUSamplerPrototypeTableValues[] =
{
    { "constructor"_s, static_cast<unsigned>(PropertyAttribute::DontEnum), NoIntrinsic, { HashTableValue::GetterSetterType, jsGPUSamplerConstructor, 0 } },
    { "label"_s, JSC::PropertyAttribute::CustomAccessor | JSC::PropertyAttribute::DOMAttribute, NoIntrinsic, { HashTableValue::GetterSetterType, jsGPUSampler_label, setJSGPUSampler_label } },
};
...
JSC_DEFINE_CUSTOM_GETTER(jsGPUSamplerConstructor, (JSGlobalObject* lexicalGlobalObject, EncodedJSValue thisValue, PropertyName))
{
    ...
    return JSValue::encode(JSGPUSampler::getConstructor(JSC::getVM(lexicalGlobalObject), prototype->globalObject()));
}
...
bool JSGPUSamplerOwner::isReachableFromOpaqueRoots(JSC::Handle<JSC::Unknown> handle, void*, AbstractSlotVisitor& visitor, const char** reason)
{
    UNUSED_PARAM(handle);
...
void JSGPUSamplerOwner::finalize(JSC::Handle<JSC::Unknown> handle, void* context)
{
    ...
    uncacheWrapper(world, &jsGPUSampler->wrapped(), jsGPUSampler);
}
...
JSC::JSValue toJSNewlyCreated(JSC::JSGlobalObject*, JSDOMGlobalObject* globalObject, Ref<GPUSampler>&& impl)
{
    ...
    if constexpr (std::is_polymorphic_v<GPUSampler>) {
#if ENABLE(BINDING_INTEGRITY)
