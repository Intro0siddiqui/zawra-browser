...
public:
    ...
    {
        JSSVGFEPointLightElement* ptr = new (NotNull, JSC::allocateCell<JSSVGFEPointLightElement>(globalObject->vm())) JSSVGFEPointLightElement(structure, *globalObject, WTFMove(impl));
