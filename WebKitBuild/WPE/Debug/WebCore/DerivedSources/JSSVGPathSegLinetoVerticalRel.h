...
public:
    ...
    {
        JSSVGPathSegLinetoVerticalRel* ptr = new (NotNull, JSC::allocateCell<JSSVGPathSegLinetoVerticalRel>(globalObject->vm())) JSSVGPathSegLinetoVerticalRel(structure, *globalObject, WTFMove(impl));
