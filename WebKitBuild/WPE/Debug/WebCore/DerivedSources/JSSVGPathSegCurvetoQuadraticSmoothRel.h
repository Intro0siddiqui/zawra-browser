...
public:
    ...
    {
        JSSVGPathSegCurvetoQuadraticSmoothRel* ptr = new (NotNull, JSC::allocateCell<JSSVGPathSegCurvetoQuadraticSmoothRel>(globalObject->vm())) JSSVGPathSegCurvetoQuadraticSmoothRel(structure, *globalObject, WTFMove(impl));
