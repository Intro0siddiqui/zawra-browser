...
public:
    ...
    {
        JSSVGFEConvolveMatrixElement* ptr = new (NotNull, JSC::allocateCell<JSSVGFEConvolveMatrixElement>(globalObject->vm())) JSSVGFEConvolveMatrixElement(structure, *globalObject, WTFMove(impl));
