...
public:
    ...
    {
        JSSVGTransformList* ptr = new (NotNull, JSC::allocateCell<JSSVGTransformList>(globalObject->vm())) JSSVGTransformList(structure, *globalObject, WTFMove(impl));
...
class JSSVGTransformListOwner final : public JSC::WeakHandleOwner {
public:
