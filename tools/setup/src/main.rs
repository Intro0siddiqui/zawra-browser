...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    let target_dir = Path::new("dependencies/WebKit");
    ...
    // We want the contents directly in dependencies/WebKit/
    ...
    if patch_dir.exists() {
        ...
        // Use a loop to copy contents of patches/webkit into dependencies/WebKit
