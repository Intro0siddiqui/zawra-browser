...
public:
    ...
    {
        JSSVGFEGaussianBlurElement* ptr = new (NotNull, JSC::allocateCell<JSSVGFEGaussianBlurElement>(globalObject->vm())) JSSVGFEGaussianBlurElement(structure, *globalObject, WTFMove(impl));
