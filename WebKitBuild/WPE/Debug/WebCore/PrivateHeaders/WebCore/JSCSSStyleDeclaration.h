...
public:
    ...
    {
        JSCSSStyleDeclaration* ptr = new (NotNull, JSC::allocateCell<JSCSSStyleDeclaration>(globalObject->vm())) JSCSSStyleDeclaration(structure, *globalObject, WTFMove(impl));
