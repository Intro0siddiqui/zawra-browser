...
public:
    ...
    {
        JSSVGUnitTypes* ptr = new (NotNull, JSC::allocateCell<JSSVGUnitTypes>(globalObject->vm())) JSSVGUnitTypes(structure, *globalObject, WTFMove(impl));
...
class JSSVGUnitTypesOwner final : public JSC::WeakHandleOwner {
public:
