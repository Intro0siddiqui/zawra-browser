...
public:
    ...
    {
        JSSVGFEMergeNodeElement* ptr = new (NotNull, JSC::allocateCell<JSSVGFEMergeNodeElement>(globalObject->vm())) JSSVGFEMergeNodeElement(structure, *globalObject, WTFMove(impl));
