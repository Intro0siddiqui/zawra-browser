...
public:
    ...
    {
        JSSVGFESpotLightElement* ptr = new (NotNull, JSC::allocateCell<JSSVGFESpotLightElement>(globalObject->vm())) JSSVGFESpotLightElement(structure, *globalObject, WTFMove(impl));
