...
public:
    ...
    {
        JSSVGFETurbulenceElement* ptr = new (NotNull, JSC::allocateCell<JSSVGFETurbulenceElement>(globalObject->vm())) JSSVGFETurbulenceElement(structure, *globalObject, WTFMove(impl));
