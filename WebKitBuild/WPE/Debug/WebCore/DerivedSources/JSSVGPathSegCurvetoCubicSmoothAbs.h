...
public:
    ...
    {
        JSSVGPathSegCurvetoCubicSmoothAbs* ptr = new (NotNull, JSC::allocateCell<JSSVGPathSegCurvetoCubicSmoothAbs>(globalObject->vm())) JSSVGPathSegCurvetoCubicSmoothAbs(structure, *globalObject, WTFMove(impl));
