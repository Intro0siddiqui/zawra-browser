...
public:
    ...
    {
        JSSVGPathSegLinetoVerticalAbs* ptr = new (NotNull, JSC::allocateCell<JSSVGPathSegLinetoVerticalAbs>(globalObject->vm())) JSSVGPathSegLinetoVerticalAbs(structure, *globalObject, WTFMove(impl));
