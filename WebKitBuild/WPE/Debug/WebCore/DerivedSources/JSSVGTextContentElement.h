...
public:
    ...
    {
        JSSVGTextContentElement* ptr = new (NotNull, JSC::allocateCell<JSSVGTextContentElement>(globalObject->vm())) JSSVGTextContentElement(structure, *globalObject, WTFMove(impl));
