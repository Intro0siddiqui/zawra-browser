...
template<> GPUPipelineDescriptorBase convertDictionary<GPUPipelineDescriptorBase>(JSGlobalObject& lexicalGlobalObject, JSValue value)
{
    ...
    GPUPipelineDescriptorBase result;
    JSValue labelValue;
