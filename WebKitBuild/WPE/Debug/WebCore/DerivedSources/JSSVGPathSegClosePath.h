...
public:
    ...
    {
        JSSVGPathSegClosePath* ptr = new (NotNull, JSC::allocateCell<JSSVGPathSegClosePath>(globalObject->vm())) JSSVGPathSegClosePath(structure, *globalObject, WTFMove(impl));
