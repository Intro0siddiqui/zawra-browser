...
public:
    ...
    {
        JSSVGRadialGradientElement* ptr = new (NotNull, JSC::allocateCell<JSSVGRadialGradientElement>(globalObject->vm())) JSSVGRadialGradientElement(structure, *globalObject, WTFMove(impl));
