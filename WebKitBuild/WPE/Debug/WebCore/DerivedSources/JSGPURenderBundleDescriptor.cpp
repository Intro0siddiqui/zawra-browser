...
template<> GPURenderBundleDescriptor convertDictionary<GPURenderBundleDescriptor>(JSGlobalObject& lexicalGlobalObject, JSValue value)
{
    ...
    GPURenderBundleDescriptor result;
    JSValue labelValue;
