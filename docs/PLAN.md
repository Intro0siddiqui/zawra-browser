...
| `cd subsystems/hajr && zig build test` | IPC Engine | Verification of hardened ring buffers. |
| `cd subsystems/z-net && zig build test` | Network Bridge | Testing the Zig-to-Rust network bridge. |
