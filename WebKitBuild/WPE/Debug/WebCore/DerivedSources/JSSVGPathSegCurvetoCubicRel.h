...
public:
    ...
    {
        JSSVGPathSegCurvetoCubicRel* ptr = new (NotNull, JSC::allocateCell<JSSVGPathSegCurvetoCubicRel>(globalObject->vm())) JSSVGPathSegCurvetoCubicRel(structure, *globalObject, WTFMove(impl));
