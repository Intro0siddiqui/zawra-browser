...
{
    static constexpr std::pair<ComparableASCIILiteral, GPUBufferBindingType> mappings[] = {
...
template<> const char* expectedEnumerationValues<GPUBufferBindingType>()
{
    return "\"uniform\", \"storage\", \"read-only-storage\"";
}
