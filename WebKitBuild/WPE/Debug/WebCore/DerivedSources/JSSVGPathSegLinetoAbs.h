...
public:
    ...
    {
        JSSVGPathSegLinetoAbs* ptr = new (NotNull, JSC::allocateCell<JSSVGPathSegLinetoAbs>(globalObject->vm())) JSSVGPathSegLinetoAbs(structure, *globalObject, WTFMove(impl));
