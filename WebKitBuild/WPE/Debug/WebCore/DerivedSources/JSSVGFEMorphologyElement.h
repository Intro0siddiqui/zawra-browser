...
public:
    ...
    {
        JSSVGFEMorphologyElement* ptr = new (NotNull, JSC::allocateCell<JSSVGFEMorphologyElement>(globalObject->vm())) JSSVGFEMorphologyElement(structure, *globalObject, WTFMove(impl));
