...
public:
    ...
    {
        JSSVGLinearGradientElement* ptr = new (NotNull, JSC::allocateCell<JSSVGLinearGradientElement>(globalObject->vm())) JSSVGLinearGradientElement(structure, *globalObject, WTFMove(impl));
