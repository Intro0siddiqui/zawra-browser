...
public:
    ...
    {
        JSSVGFEDiffuseLightingElement* ptr = new (NotNull, JSC::allocateCell<JSSVGFEDiffuseLightingElement>(globalObject->vm())) JSSVGFEDiffuseLightingElement(structure, *globalObject, WTFMove(impl));
