...
template <bool shouldCreateIdentifier> ALWAYS_INLINE JSTokenType Lexer<UChar>::parseKeyword(JSTokenData* data)
{
    ...
    if (code[0] == 't') {
        ...
        if (code[1] == 'f') {
            ...
            if (COMPARE_8UCHARS(code + 2, 's', 't', 'a', 'n', 'c', 'e', 'o', 'f')) {
            ...
            } else if (COMPARE_7UCHARS(code + 2, 't', 'e', 'r', 'f', 'a', 'c', 'e')) {
        ...
        if (COMPARE_4UCHARS(code, 'e', 'l', 's', 'e')) {
            ...
            if (COMPARE_5UCHARS(code + 2, 't', 'e', 'n', 'd', 's')) {
                if (LIKELY(cannotBeIdentPartOrEscapeStart(code[7]))) {
                    internalShift<7>();
                    if (shouldCreateIdentifier)
            ...
            } else if (COMPARE_4UCHARS(code + 2, 'p', 'o', 'r', 't')) {
                if (LIKELY(cannotBeIdentPartOrEscapeStart(code[6]))) {
                    internalShift<6>();
                    if (shouldCreateIdentifier)
        ...
        if (code[1] == 'a') {
            ...
            } else if (COMPARE_4UCHARS(code + 1, 'a', 't', 'c', 'h')) {
                if (LIKELY(cannotBeIdentPartOrEscapeStart(code[5]))) {
                    internalShift<5>();
                    if (shouldCreateIdentifier)
            ...
            } else if (COMPARE_5UCHARS(code + 3, 't', 'i', 'n', 'u', 'e')) {
                if (LIKELY(cannotBeIdentPartOrEscapeStart(code[8]))) {
                    internalShift<8>();
                    if (shouldCreateIdentifier)
        ...
        if (COMPARE_4UCHARS(code + 1, 'u', 'p', 'e', 'r')) {
            if (LIKELY(cannotBeIdentPartOrEscapeStart(code[5]))) {
                internalShift<5>();
                if (shouldCreateIdentifier)
        ...
        } else if (COMPARE_5UCHARS(code + 1, 'w', 'i', 't', 'c', 'h')) {
            if (LIKELY(cannotBeIdentPartOrEscapeStart(code[6]))) {
                internalShift<6>();
                if (shouldCreateIdentifier)
        ...
        if (COMPARE_6UCHARS(code + 1, 'a', 'c', 'k', 'a', 'g', 'e')) {
            if (LIKELY(cannotBeIdentPartOrEscapeStart(code[7]))) {
                internalShift<7>();
                if (shouldCreateIdentifier)
...
template <bool shouldCreateIdentifier> ALWAYS_INLINE JSTokenType Lexer<LChar>::parseKeyword(JSTokenData* data)
{
    ...
    if (code[0] == 't') {
        ...
        if (code[1] == 'f') {
            ...
            if (COMPARE_8CHARS(code + 2, 's', 't', 'a', 'n', 'c', 'e', 'o', 'f')) {
                if (LIKELY(cannotBeIdentPartOrEscapeStart(code[10]))) {
                    internalShift<10>();
                    if (shouldCreateIdentifier)
                        data->ident = &m_vm.propertyNames->instanceofKeyword;
            ...
            } else if (COMPARE_7CHARS(code + 2, 't', 'e', 'r', 'f', 'a', 'c', 'e')) {
                if (LIKELY(cannotBeIdentPartOrEscapeStart(code[9]))) {
                    internalShift<9>();
                    if (shouldCreateIdentifier)
                        data->ident = &m_vm.propertyNames->interfaceKeyword;
        ...
        if (COMPARE_4CHARS(code, 'e', 'l', 's', 'e')) {
            ...
            if (COMPARE_5CHARS(code + 2, 't', 'e', 'n', 'd', 's')) {
                if (LIKELY(cannotBeIdentPartOrEscapeStart(code[7]))) {
                    internalShift<7>();
                    if (shouldCreateIdentifier)
                        data->ident = &m_vm.propertyNames->extendsKeyword;
            ...
            } else if (COMPARE_4CHARS(code + 2, 'p', 'o', 'r', 't')) {
                if (LIKELY(cannotBeIdentPartOrEscapeStart(code[6]))) {
                    internalShift<6>();
                    if (shouldCreateIdentifier)
                        data->ident = &m_vm.propertyNames->exportKeyword;
        ...
        if (code[1] == 'a') {
            ...
            } else if (COMPARE_4CHARS(code + 1, 'a', 't', 'c', 'h')) {
                if (LIKELY(cannotBeIdentPartOrEscapeStart(code[5]))) {
                    internalShift<5>();
                    if (shouldCreateIdentifier)
                        data->ident = &m_vm.propertyNames->catchKeyword;
            ...
            } else if (COMPARE_5CHARS(code + 3, 't', 'i', 'n', 'u', 'e')) {
                if (LIKELY(cannotBeIdentPartOrEscapeStart(code[8]))) {
                    internalShift<8>();
                    if (shouldCreateIdentifier)
                        data->ident = &m_vm.propertyNames->continueKeyword;
        ...
        if (COMPARE_4CHARS(code + 1, 'u', 'p', 'e', 'r')) {
            if (LIKELY(cannotBeIdentPartOrEscapeStart(code[5]))) {
                internalShift<5>();
                if (shouldCreateIdentifier)
                    data->ident = &m_vm.propertyNames->superKeyword;
        ...
        } else if (COMPARE_5CHARS(code + 1, 'w', 'i', 't', 'c', 'h')) {
            if (LIKELY(cannotBeIdentPartOrEscapeStart(code[6]))) {
                internalShift<6>();
                if (shouldCreateIdentifier)
                    data->ident = &m_vm.propertyNames->switchKeyword;
        ...
        if (COMPARE_6CHARS(code + 1, 'a', 'c', 'k', 'a', 'g', 'e')) {
            if (LIKELY(cannotBeIdentPartOrEscapeStart(code[7]))) {
                internalShift<7>();
                if (shouldCreateIdentifier)
                    data->ident = &m_vm.propertyNames->packageKeyword;
