...
public:
    ...
    {
        JSSVGAnimateMotionElement* ptr = new (NotNull, JSC::allocateCell<JSSVGAnimateMotionElement>(globalObject->vm())) JSSVGAnimateMotionElement(structure, *globalObject, WTFMove(impl));
