...
public:
    ...
    {
        JSSVGNumberList* ptr = new (NotNull, JSC::allocateCell<JSSVGNumberList>(globalObject->vm())) JSSVGNumberList(structure, *globalObject, WTFMove(impl));
...
class JSSVGNumberListOwner final : public JSC::WeakHandleOwner {
public:
