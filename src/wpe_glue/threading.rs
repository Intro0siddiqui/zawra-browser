...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn Zawra_Thread_Create(
    func: unsafe extern "C" fn(*mut c_void) -> *mut c_void,
    arg: *mut c_void,
) -> ThreadHandle {
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn Zawra_Thread_Join(handle: ThreadHandle) -> c_int {
    unsafe { hajr_thread_join(handle) }
}

/// Set the priority of a thread.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn Zawra_Thread_SetPriority(handle: ThreadHandle, priority: u8) -> c_int {
