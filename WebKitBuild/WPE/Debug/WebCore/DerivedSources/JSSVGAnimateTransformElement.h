...
public:
    ...
    {
        JSSVGAnimateTransformElement* ptr = new (NotNull, JSC::allocateCell<JSSVGAnimateTransformElement>(globalObject->vm())) JSSVGAnimateTransformElement(structure, *globalObject, WTFMove(impl));
