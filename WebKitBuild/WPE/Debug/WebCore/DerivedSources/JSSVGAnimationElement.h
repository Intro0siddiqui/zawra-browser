...
public:
    ...
    {
        JSSVGAnimationElement* ptr = new (NotNull, JSC::allocateCell<JSSVGAnimationElement>(globalObject->vm())) JSSVGAnimationElement(structure, *globalObject, WTFMove(impl));
