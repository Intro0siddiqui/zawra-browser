...
template<> GPUCommandBufferDescriptor convertDictionary<GPUCommandBufferDescriptor>(JSGlobalObject& lexicalGlobalObject, JSValue value)
{
    ...
    GPUCommandBufferDescriptor result;
    JSValue labelValue;
