...
public:
    ...
    {
        JSSVGPointList* ptr = new (NotNull, JSC::allocateCell<JSSVGPointList>(globalObject->vm())) JSSVGPointList(structure, *globalObject, WTFMove(impl));
...
class JSSVGPointListOwner final : public JSC::WeakHandleOwner {
public:
