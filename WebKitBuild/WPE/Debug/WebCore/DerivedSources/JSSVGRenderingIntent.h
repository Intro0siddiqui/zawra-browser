...
public:
    ...
    {
        JSSVGRenderingIntent* ptr = new (NotNull, JSC::allocateCell<JSSVGRenderingIntent>(globalObject->vm())) JSSVGRenderingIntent(structure, *globalObject, WTFMove(impl));
...
class JSSVGRenderingIntentOwner final : public JSC::WeakHandleOwner {
public:
